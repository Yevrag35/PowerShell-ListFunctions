...
$hash = [ListFunctions.Modern.HashCodeBlock[psobject]]::new({ [System.HashCode]::Combine($_.Name.ToLower(), "Name") })
$empty = [array]::Empty[System.Management.Automation.PSVariable]()

$eqScr = { $left.Name -eq $right.Name }
$equal = [ListFunctions.Modern.EqualityBlock[psobject]]::new($eqScr, $hash, $empty)
